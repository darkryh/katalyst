...
Katalyst uses **Exposed 1.1.1** with JDBC transaction support for type-safe database operations. This guide details the imports, transaction patterns, and best practices for working with Exposed in Katalyst.

## Version Information

- **Exposed Version**: 1.1.1
...
- **Reference Exposed 1.1.1 documentation** for advanced DSL patterns not covered here
