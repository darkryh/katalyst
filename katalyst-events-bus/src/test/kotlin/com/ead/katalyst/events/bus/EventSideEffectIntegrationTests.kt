...
import com.ead.katalyst.transactions.sideeffects.SideEffectResult
...
class EventSideEffectIntegrationTests {
    ...
    fun testEventSideEffectWorksAsTransactionalSideEffect() = runBlocking {
        ...
        assertTrue(sideEffect is com.ead.katalyst.transactions.sideeffects.TransactionalSideEffect<*>)
