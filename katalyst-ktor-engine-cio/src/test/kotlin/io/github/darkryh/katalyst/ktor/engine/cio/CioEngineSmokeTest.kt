...
/**
 * Engine-matrix smoke test (Phase 5): boots the **real** CIO engine on an ephemeral port, serves a
 * request, and shuts down cleanly.
 */
class CioEngineSmokeTest {

    @Test
    fun `cio engine starts, serves a request, and stops cleanly`() {
