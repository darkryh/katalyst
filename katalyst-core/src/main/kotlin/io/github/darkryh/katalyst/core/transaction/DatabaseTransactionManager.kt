package io.github.darkryh.katalyst.core.transaction

import io.github.darkryh.katalyst.transactions.manager.DatabaseTransactionManager as TransactionsModuleManager
 ...
 *
 * **Real Implementation:**
 * The actual implementation is in `io.github.darkryh.katalyst.transactions.manager.DatabaseTransactionManager`
 * with full hook support and event context management.
 *
 * @see io.github.darkryh.katalyst.transactions.manager.DatabaseTransactionManager
 */
