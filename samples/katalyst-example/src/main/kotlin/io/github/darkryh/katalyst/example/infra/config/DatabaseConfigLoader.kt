...
object DatabaseConfigLoader : ServiceConfigLoader<DatabaseConfig> {
     ...
     * @throws io.github.darkryh.katalyst.core.config.ConfigException if required keys are missing
     */
     ...
     * @throws io.github.darkryh.katalyst.core.config.ConfigException if validation fails
     */
