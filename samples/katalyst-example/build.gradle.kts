plugins {
    ...
    // A published consumer would write: id("io.github.darkryh.katalyst") version "1.0.0-alpha10"
    id("io.github.darkryh.katalyst") version "1.0.0-alpha10"
}
