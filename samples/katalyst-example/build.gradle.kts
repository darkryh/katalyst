plugins {
    ...
    // A published consumer would write: id("io.github.darkryh.katalyst") version "1.0.0-beta01"
    id("io.github.darkryh.katalyst") version "1.0.0-beta01"
}
